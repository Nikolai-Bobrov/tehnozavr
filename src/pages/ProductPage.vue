        ...
        <div class="item__form">
          <form class="form" action="#" method="POST">
            ...
            <fieldset class="form__block">
              ...
              <ul class="colors">
                <li class="colors__item" v-for="colorIt in product.colors">
                  <label class="colors__label">
                    <input class="colors__radio sr-only" type="radio" name="color-item" :value="colorIt.color" checked="">
...
export default {
  ...
  computed: {
    ...
    category(){
      return categories.find(categoru => categoru.id === this.product.categoryId)
    }
  },
  methods: {
    gotoPage
